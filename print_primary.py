...
print('spainia')
print()
print('Can', 'you', 'pay', 'my', 'bills?')
print('Can','you','pay','my','telephone','bills?')
print('Do','you','pay','my','automo','bills?')
print('If','you','did','then','maybe','we','could','chill')
print()
